// Advanced authentication utilities for HumanGrid
...
export function createSignInMessage(address, nonce) {
    const domain = typeof window !== 'undefined' ? window.location.host : 'humangrid.ai'
    const timestamp = new Date().toISOString()

    return `Welcome to HumanGrid!
...
export const SessionManager = {
    ...
    saveSession(address, signature, nonce) {
        ...
        if (typeof window !== 'undefined') {
            localStorage.setItem('humangrid_session', JSON.stringify(session))
        }
    ...
    getSession() {
        ...
        const sessionStr = localStorage.getItem('humangrid_session')
    ...
    clearSession() {
        if (typeof window !== 'undefined') {
            localStorage.removeItem('humangrid_session')
        }
    },
